...
public class LoginActivity extends AppCompatActivity {
    ...
    private void login() {
        ...
        apiService.login(mEmailView.getText().toString(), mPasswordView.getText().toString()).enqueue(new Callback<Authorization>() {
            @Override
            public void onResponse(Call<Authorization> call, Response<Authorization> response) {
                if(response.isSuccessful()) {
                    ...
                    editor.putString(mAuthPreferenceName, authorization.token).apply();
